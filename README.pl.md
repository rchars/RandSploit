...
Eksperymentalny, modularny CLI-toolkit do narzędzi sieciowych i systemowych z interaktywnym interpreterem wzorowanym na Metasploit

## Opis

RandSploit to projekt stworzony jako próba zbudowania elastycznego i rozszerzalnego środowiska do pracy z narzędziami związanymi z infrastrukturą, sieciami i cyberbezpieczeństwem.
Głównym założeniem było stworzenie własnego interpretera CLI, który umożliwia dynamiczne ładowanie modułów ("pluginów") w trakcie działania programu oraz zarządzanie ich konfiguracją i parametrami w jednolity sposób.
Projekt nie jest już rozwijany i pozostaje w formie proof-of-concept.
Dalsze prace zostały przeniesione do nowego toolkitu rozwijanego w prywatnym repozytorium.
